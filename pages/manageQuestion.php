...
<body class="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container py-4">
            <div class="col-md-12 ">
                <h4 class="text-center mb-4 text-primary">Manage Questions</h4>
                                ...
                                <tbody>
                                    <?php foreach ($questions as $index => $question): ?>
                                        <tr>
                                            ...
                                            <td class='text-left' style="text-align: left !important;"><?php echo strip_tags($question['question_text']); ?></td>
                                            <td>
                                            ...
                                            <td class='text-left' style="text-align: left !important;">
                                                <strong>(A) </strong> <?php echo strip_tags($question['option_a']); ?><br>
                                                <strong>(B) </strong> <?php echo strip_tags($question['option_b']); ?><br>
                                                <strong>(C) </strong> <?php echo strip_tags($question['option_c']); ?><br>
                                                <strong>(D) </strong> <?php echo strip_tags($question['option_d']); ?>
                                            </td>

                                            <td><?php echo htmlspecialchars($question['correct_answer']); ?></td>
                                            <td>
                                                <div class='btn-group' role='group'>
                                                    <a href="editQuestion.php?id=<?php echo $question['id']; ?>" class='btn btn-warning btn-sm action-btn' data-toggle='tooltip' title='Edit Question'>Edit</a>

                                                    <button class='btn  btn-danger btn-md delete-btn' data-id='<?php echo $question['id']; ?>' data-bs-toggle='tooltip' title='Delete Teacher'>
                                                        Delete
                                                    </button>
                                                </div>
                                            </td>
