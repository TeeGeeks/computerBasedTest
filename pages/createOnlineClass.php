...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['createClass'])) {
    ...
    // Echo the form data for debugging
    ...
    // // Prepare the event data using dummy data for testing
    // $formData = [
    //     'class' => '1', // Replace with a valid class ID for testing
    //     'arm' => '1',   // Replace with a valid arm ID for testing
    //     'subject' => '1', // Replace with a valid subject ID for testing
    //     'classTitle' => 'Test Online Class',
    //     'classDescription' => 'This is a test description for the online class.',
    //     'classDate' => '2024-10-30', // Use a future date for testing
    //     'classTime' => '14:00:00', // Use a valid time in HH:MM:SS format
    //     'classDuration' => 60 // Duration in minutes
    // ];
    ...
    error_log('Event Request Data: ' . json_encode($eventData)); // Log the event data for debugging
    ...
    // Escape form inputs before inserting into the database
    ...
    $query = "INSERT INTO online_classes (teacher_id, class_id, arm_id, subject_id, class_title, class_description, class_link, class_date, class_time, class_duration) 
              VALUES ($teacherId, {$formData['class']}, {$formData['arm']}, {$formData['subject']}, '$classTitle', '$classDescription', '$classLink', '$classDate', '$classTime', {$formData['classDuration']})";

    if (mysqli_query($connection, $query)) {
        showSweetAlert('success', 'Class Created', 'Your online class has been created successfully!', 'manageOnlineClass.php');
    } else {
        error_log('Database Error: ' . mysqli_error($connection)); // Log database errors
        showSweetAlert('error', 'Error', 'There was an error creating the class. Please try again.');
    }
}
...
<body class="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container py-4 d-flex justify-content-center mt-3">
            <div class="col-md-10">
                <h4 class="text-center mb-4">Create Online Class</h4>

                <form id="createClassForm" action="" method="POST" onsubmit="showSpinner()">
                    <div class="row">
                        <!-- Class Dropdown -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="classTitle" name="classTitle" required>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" class="form-control" id="classDuration" name="classDuration" required min="1" placeholder="e.g., 30">
                        </div>
                    </div>

                    <div class="col-md-12 mb-3">
                        <label for="classDescription" class="form-label">Class Description</label>
                        <textarea class="form-control" id="classDescription" name="classDescription" rows="4"></textarea>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const currentPage = 'Create Online Class';
