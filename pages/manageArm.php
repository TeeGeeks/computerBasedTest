...
$arms = fetchArms(); // Assume this function fetches the arms from your database
?>
...
<body class="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid">
            <h4 class="mt-4 text-primary">Arms List</h4>
            <a href="addArm.php" class="btn btn-primary mb-3">Add New Arm</a>
            ...
            <div class="table-responsive">
                <table id="assignmentsTable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        foreach ($arms as $arm) {
                            $id = $arm['arm_id']; // Assuming you have the 'id' in your $arm array

                            echo "<tr>";
                            echo "<td>{$counter}</td>"; // Serial number
                            echo "<td>{$arm['arm_name']}</td>"; // arm Name
                            echo "<td>
                                <div class='btn-group' role='group'>
                                   <a href='editArm.php?id={$id}' class='btn btn-info btn-sm' data-toggle='tooltip' title='Edit arm'>
                                        Update
                                    </a>
                ...
                button.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            fetch(`../endpoints/delete_arm.php?id=${id}`, {
                                    method: 'GET'
                                })
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const currentPage = 'Manage arm'; // Update this dynamically based on your context
